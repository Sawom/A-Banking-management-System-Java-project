...
public class AddEmployeeController implements Initializable {
    ...
    @FXML
    private void goCommissionEmployee(ActionEvent event) throws IOException {
    ...
    @FXML
    private void goSalariedEmployee(ActionEvent event) throws IOException {
    ...
    @FXML
    private void goHourlyEmployee(ActionEvent event) throws IOException {
